...
export default {
  ...
  methods: {
    mergeItem () {
      ...
      if (!this.purchaseId) {
        this.$confirm(
          ...
          .then(() => {
            this.$http({
              url: this.$http.adornUrl('/ecmall4cloudware/purchase/merge'),
              method: 'post',
    ...
    getUnreceivedPurchase () {
      this.$http({
        url: this.$http.adornUrl('/ecmall4cloudware/purchase/unreceive/list'),
        method: 'get',
    ...
    getWares () {
      this.$http({
        url: this.$http.adornUrl('/ecmall4cloudware/wareinfo/list'),
        method: 'get',
        params: this.$http.adornParams({
          page: 1,
          limit: 500
    ...
    getDataList () {
      ...
      this.$http({
        url: this.$http.adornUrl('/ecmall4cloudware/purchasedetail/list'),
        method: 'get',
        params: this.$http.adornParams({
          page: this.pageIndex,
          limit: this.pageSize,
    ...
    deleteHandle (id) {
      ...
      this.$confirm(
        ...
        this.$http({
          url: this.$http.adornUrl('/ecmall4cloudware/purchasedetail/delete'),
          method: 'post',
